  ...
  return (
    <div className="bg-transparent min-h-screen text-white relative overflow-hidden">
      ...
      <Section className="py-20 bg-transparent relative z-10">
        <Container>
          <div className="max-w-2xl mx-auto mb-16 text-center space-y-3">
            <span className="text-xs font-mono font-bold tracking-widest text-primary uppercase block">Our Process</span>
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-white tracking-tight">The Engagement Timeline</h2>
          </div>
      ...
      <Section className="py-20 bg-transparent relative z-10">
        <Container>
          <div className="max-w-2xl mx-auto mb-16 text-center space-y-3">
            <span className="text-xs font-mono font-bold tracking-widest text-primary uppercase block">Ecosystem</span>
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-white tracking-tight">Technology & Security Stack</h2>
          </div>
      ...
      <Section className="py-20 bg-transparent relative z-10">
        <Container>
          <div className="max-w-2xl mx-auto mb-16 text-center space-y-3">
            <span className="text-xs font-mono font-bold tracking-widest text-primary uppercase block">Why Kodesec</span>
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-white tracking-tight">Engineered for Technical Authority</h2>
          </div>
            ...
            {whyChooseUs.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-heading font-bold text-white tracking-tight mb-3">
                    {item.title}
                  </h3>
